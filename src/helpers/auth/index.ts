...
if (!COGNITO_USER_POOL_ID || !COGNITO_CLIENT_ID) {
  console.error(
    'Missing required environment variables: NEXT_PUBLIC_COGNITO_USER_POOL_ID or NEXT_PUBLIC_COGNITO_CLIENT_ID'
  );
}
...
export const isAuthenticated = async (): Promise<boolean> => {
  try {
    ...
    let apiUrl =
      ...
      'https://xtxfuhrel1.execute-api.us-west-1.amazonaws.com/prod';
    if (!apiUrl.endsWith('/')) {
      apiUrl += '/';
    }
